...
from rp.libs.jedi.parser_utils import clean_scope_docstring
from rp.libs.jedi.common import BaseContextSet, BaseContext
from rp.libs.jedi.evaluate.helpers import SimpleGetItemNotFound
...
class HelperContextMixin(object):
    ...
    def py__getattribute__(self, name_or_str, name_context=None, position=None,
        ...
        if name_context is None:
            name_context = self
        from rp.libs.jedi.evaluate import finder
...
class _ContextWrapperBase(HelperContextMixin):
    ...
    @safe_property
    def name(self):
        from rp.libs.jedi.evaluate.names import ContextName
        ...
        if wrapped_name.tree_name is not None:
            ...
            from rp.libs.jedi.evaluate.compiled import CompiledContextName
...
def _getitem(context, index_contexts, contextualized_node):
    from rp.libs.jedi.evaluate.context.iterable import Slice
...
class ContextSet(BaseContextSet):
    ...
    def iterate(self, contextualized_node=None, is_async=False):
        from rp.libs.jedi.evaluate.lazy_context import get_merged_lazy_context
