...
from rp.libs.jedi.evaluate import docstrings
from rp.libs.jedi.evaluate import flow_analysis
from rp.libs.jedi.evaluate import helpers
from rp.libs.jedi.evaluate.signature import TreeSignature
from rp.libs.jedi.evaluate.arguments import AnonymousArguments
from rp.libs.jedi.evaluate.filters import ParserTreeFilter, FunctionExecutionFilter
from rp.libs.jedi.evaluate.names import ContextName, AbstractNameDefinition, ParamName
from rp.libs.jedi.evaluate.base_context import ContextualizedNode, NO_CONTEXTS, \
    ContextSet, TreeContext, ContextWrapper
from rp.libs.jedi.evaluate.lazy_context import LazyKnownContexts, LazyKnownContext, \
    LazyTreeContext
from rp.libs.jedi.evaluate.context import iterable
from rp.libs.jedi import parser_utils
from rp.libs.jedi.evaluate.parser_cache import get_yield_exprs
from rp.libs.jedi.evaluate.helpers import contexts_from_qualified_names
...
class FunctionMixin(object):
    ...
    def py__get__(self, instance, class_context):
        from rp.libs.jedi.evaluate.context.instance import BoundMethod
        if instance is None:
...
class FunctionExecutionContext(TreeContext):
    ...
    def get_return_values(self, check_yields=False):
        ...
        if check_yields:
            ...
            from rp.libs.jedi.evaluate.gradual.annotation import infer_return_types
