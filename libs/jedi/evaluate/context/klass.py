...
from rp.libs.jedi.parser_utils import get_cached_parent_scope
from rp.libs.jedi.evaluate.cache import evaluator_method_cache, CachedMetaClass, \
    evaluator_method_generator_cache
from rp.libs.jedi.evaluate import compiled
from rp.libs.jedi.evaluate.lazy_context import LazyKnownContexts
from rp.libs.jedi.evaluate.filters import ParserTreeFilter
from rp.libs.jedi.evaluate.names import TreeNameDefinition, ContextName
from rp.libs.jedi.evaluate.arguments import unpack_arglist, ValuesArguments
from rp.libs.jedi.evaluate.base_context import ContextSet, iterator_to_context_set, \
    NO_CONTEXTS
from rp.libs.jedi.evaluate.context.function import FunctionAndClassBase
...
class ClassMixin(object):
    ...
    def py__call__(self, arguments=None):
        from rp.libs.jedi.evaluate.context import TreeInstance
    ...
    def get_filters(self, search_global=False, until_position=None,
        ...
        if not is_instance:
            from rp.libs.jedi.evaluate.compiled import builtin_from_name
...
class ClassContext(use_metaclass(CachedMetaClass, ClassMixin, FunctionAndClassBase)):
    ...
    def list_type_vars(self):
        ...
        for stars, node in unpack_arglist(arglist):
            ...
            from rp.libs.jedi.evaluate.gradual.annotation import find_unknown_type_vars
    ...
    def _get_bases_arguments(self):
        arglist = self.tree_node.get_super_arglist()
        if arglist:
            from rp.libs.jedi.evaluate import arguments
    ...
    def py__getitem__(self, index_context_set, contextualized_node):
        from rp.libs.jedi.evaluate.gradual.typing import LazyGenericClass
    ...
    def define_generics(self, type_var_dict):
        from rp.libs.jedi.evaluate.gradual.typing import GenericClass
