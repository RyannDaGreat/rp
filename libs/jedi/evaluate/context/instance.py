...
from rp.libs.jedi.evaluate.compiled.context import CompiledObjectFilter
...
from rp.libs.jedi.evaluate.names import ContextName, TreeNameDefinition
from rp.libs.jedi.evaluate.base_context import Context, NO_CONTEXTS, ContextSet, \
...
from rp.libs.jedi.evaluate.context.function import \
    FunctionContext, FunctionMixin, OverloadedFunctionContext
from rp.libs.jedi.evaluate.context.klass import ClassContext, apply_py__get__, \
    ClassFilter
...
class TreeInstance(AbstractInstanceContext):
    ...
    def _get_annotated_class_object(self):
        from rp.libs.jedi.evaluate.gradual.annotation import py__annotations__, \
