...
from rp.libs.jedi.file_io import KnownContentFileIO, FileIO
from rp.libs.jedi.parser_utils import get_cached_code_lines
from rp.libs.jedi.evaluate import sys_path
...
from rp.libs.jedi.evaluate.names import ImportName, SubModuleName
from rp.libs.jedi.evaluate.base_context import ContextSet, NO_CONTEXTS
from rp.libs.jedi.evaluate.gradual.typeshed import import_module_decorator
from rp.libs.jedi.evaluate.context.module import iter_module_names
...
def import_module(evaluator, import_names, parent_module_context, sys_path):
    ...
    if isinstance(file_io_or_ns, ImplicitNSInfo):
        from rp.libs.jedi.evaluate.context.namespace import ImplicitNamespaceContext
