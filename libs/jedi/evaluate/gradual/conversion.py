...
from rp.libs.jedi.evaluate.gradual.stub_context import StubModuleContext
...
def _infer_from_stub(stub_module, qualified_names, ignore_compiled):
    from rp.libs.jedi.evaluate.compiled.mixed import MixedObject
...
def _load_stub_module(module):
    if module.is_stub():
        return module
    from rp.libs.jedi.evaluate.gradual.typeshed import _try_to_load_stub_cached
