...
from rp.libs.jedi._compatibility import force_unicode, Parameter, cast_path
from rp.libs.jedi.cache import underscore_memoization, memoize_method
from rp.libs.jedi.evaluate.filters import AbstractFilter
from rp.libs.jedi.evaluate.names import AbstractNameDefinition, ContextNameMixin, \
    ParamNameInterface
from rp.libs.jedi.evaluate.base_context import Context, ContextSet, NO_CONTEXTS
from rp.libs.jedi.evaluate.lazy_context import LazyKnownContext
from rp.libs.jedi.evaluate.compiled.access import _sentinel
from rp.libs.jedi.evaluate.cache import evaluator_function_cache
from rp.libs.jedi.evaluate.helpers import reraise_getitem_errors
from rp.libs.jedi.evaluate.signature import BuiltinSignature
    ...
    def py__call__(self, arguments):
        ...
        try:
            ...
            if self.access_handle.is_class():
                from rp.libs.jedi.evaluate.context import CompiledInstance
                return ContextSet([
