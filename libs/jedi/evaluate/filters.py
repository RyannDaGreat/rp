...
from rp.libs.jedi.evaluate.base_context import ContextSet, Context, ContextWrapper, \
    LazyContextWrapper
from rp.libs.jedi.parser_utils import get_cached_parent_scope
from rp.libs.jedi.evaluate.utils import to_list
from rp.libs.jedi.evaluate.names import TreeNameDefinition, ParamName, AbstractNameDefinition
...
def get_global_filters(evaluator, context, until_position, origin_scope):
    ...
    [...]
    """
    from rp.libs.jedi.evaluate.context.function import FunctionExecutionContext
