...
from rp.libs.jedi.evaluate.utils import PushBackIterator
from rp.libs.jedi.evaluate import analysis
from rp.libs.jedi.evaluate.lazy_context import LazyKnownContext, LazyKnownContexts, \
    LazyTreeContext, get_merged_lazy_context
from rp.libs.jedi.evaluate.names import ParamName, TreeNameDefinition
from rp.libs.jedi.evaluate.base_context import NO_CONTEXTS, ContextSet, ContextualizedNode
from rp.libs.jedi.evaluate.context import iterable
from rp.libs.jedi.evaluate.cache import evaluator_as_method_param_cache
from rp.libs.jedi.evaluate.param import get_executed_params_and_issues, ExecutedParam
...
class AnonymousArguments(AbstractArguments):
    def get_executed_params_and_issues(self, execution_context):
        from rp.libs.jedi.evaluate.dynamic import search_params
...
class TreeArguments(AbstractArguments):
    ...
    def get_calling_nodes(self):
        from rp.libs.jedi.evaluate.dynamic import DynamicExecutedParams
        old_arguments_list = []
        arguments = self
...
def _star_star_dict(context, array, input_node, funcdef):
    from rp.libs.jedi.evaluate.context.instance import CompiledInstance
