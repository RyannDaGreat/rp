...
from rp.prompt_toolkit.buffer import ClipboardData, indent, unindent, reshape_text
from rp.prompt_toolkit.document import Document
from rp.prompt_toolkit.enums import IncrementalSearchDirection, SEARCH_BUFFER, SYSTEM_BUFFER
from rp.prompt_toolkit.filters import Filter, Condition, HasArg, Always, IsReadOnly, HasFocus
from rp.prompt_toolkit.filters.cli import ViNavigationMode, ViInsertMode, ViInsertMultipleMode, ViReplaceMode, ViSelectionMode, ViWaitingForTextObjectMode, ViDigraphMode, ViMode
from rp.prompt_toolkit.key_binding.digraphs import DIGRAPHS
from rp.prompt_toolkit.key_binding.vi_state import CharacterFind, InputMode
from rp.prompt_toolkit.keys import Keys
from rp.prompt_toolkit.layout.utils import find_window_for_buffer_name
from rp.prompt_toolkit.selection import SelectionType, SelectionState, PasteMode
...
def ryan_go_to_vim_navigation_mode(event):
