...
Adaptor for using the input system of `rp.prompt_toolkit` with the IPython
backend.
...
from rp.prompt_toolkit.completion import Completion, Completer
from rp.prompt_toolkit.contrib.completers import PathCompleter, WordCompleter, SystemCompleter
from rp.prompt_toolkit.contrib.regular_languages.compiler import compile
from rp.prompt_toolkit.contrib.regular_languages.completion import GrammarCompleter
from rp.prompt_toolkit.contrib.regular_languages.lexer import GrammarLexer
from rp.prompt_toolkit.document import Document
from rp.prompt_toolkit.interface import CommandLineInterface
from rp.prompt_toolkit.layout.lexers import PygmentsLexer, SimpleLexer
...
class IPython5Prompt(PromptStyle):
    """
    Style for IPython >5.0, use the rp.prompt_toolkit tokens directly.
    """
