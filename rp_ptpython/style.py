...
retro_style = {Token.Callable: 'bold #33ff33',  # Jedi semantic highlighting for callables
Token.Module: 'bold #ffff00',  # Jedi semantic highlighting for modules
Token.Parameter: '#ff8800',  # Jedi semantic highlighting for parameters
Token.Parameter.Unused: 'dim',  # Jedi semantic highlighting for parameters
Token: '', Token.Comment: 'italic #666666', Token.Comment.Hashbang: '#666666', Token.Comment.Multiline: '#666666', Token.Comment.Preproc: 'noitalic #666666', Token.Comment.PreprocFile: '', Token.Comment.Single: '', Token.Comment.Special: '', Token.Error: 'bg:#ff0000', Token.Escape: '#ffffff', Token.Generic: '', Token.Generic.Deleted: '#ff0000', Token.Generic.Emph: 'italic', Token.Generic.Error: '#ff0000', Token.Generic.Heading: '#ffff00', Token.Generic.Inserted: '#33ff33', Token.Generic.Output: '#ffffff', Token.Generic.Prompt: '#ffffff', Token.Generic.Strong: 'bold', Token.Generic.Subheading: '#ffff00', Token.Generic.Traceback: '#ff0000', Token.Keyword: '#ffff00 bold', Token.Keyword.Constant: '#ff8800 italic', Token.Keyword.Declaration: '#ffff00 bold', Token.Keyword.Namespace: '#ffff00', Token.Keyword.Pseudo: '#ffff00', Token.Keyword.Reserved: '#ffff00 bold', Token.Keyword.Type: '#ff8800 italic', Token.Literal: '', Token.Literal.Date: '', Token.Literal.Number: '#ff8800', Token.Literal.Number.Bin: '', Token.Literal.Number.Float: '', Token.Literal.Number.Hex: '', Token.Literal.Number.Integer: '', Token.Literal.Number.Integer.Long: '', Token.Literal.Number.Oct: '', Token.Literal.String: '#33ff33', Token.Literal.String.Backtick: '', Token.Literal.String.Char: '#33ff33', Token.Literal.String.Doc: '#33ff33', Token.Literal.String.Double: '', Token.Literal.String.Escape: '#ffff00', Token.Literal.String.Heredoc: '', Token.Literal.String.Interpol: '#ffff00', Token.Literal.String.Other: '#33ff33', Token.Literal.String.Regex: '#ffff00', Token.Literal.String.Single: '', Token.Literal.String.Symbol: '#ff8800', Token.Name: '#ffffff', Token.Name.Attribute: '#33ff33', Token.Name.Builtin: '#ffff00 bold', Token.Name.Builtin.Pseudo: '#ff8800 italic', Token.Name.Class: '#33ff33 bold', Token.Name.Constant: '#33ff33 bold', Token.Name.Decorator: '#ffff00', Token.Name.Entity: '#ffffff', Token.Name.Exception: '#ff0000 bold', Token.Name.Function: '#ffff00', Token.Name.Label: '#ffffff', Token.Name.Namespace: '#33ff33', Token.Name.Other: '#ffffff', Token.Name.Property: '#ffffff', Token.Name.Tag: '#ff0000', Token.Name.Variable: '#ff0000', Token.Name.Variable.Class: '#ff0000 italic', Token.Name.Variable.Global: '#ff0000 bold', Token.Name.Variable.Instance: '#ff0000', Token.Operator: '#ff0000', Token.Operator.Word: '#ffff00 bold', Token.Punctuation: '#ffffff', Token.Text: '#ffffff', Token.Text.Whitespace: ''}
...
ryan_style={Token: '',
            Token.Callable: 'bold #388038',  # Jedi semantic highlighting for callables
            Token.Module: 'bold #289870',  # Jedi semantic highlighting for modules
            Token.Parameter: 'bold #289870',  # Jedi semantic highlighting for parameters
            Token.Parameter.Unused: 'dim',  # Jedi semantic highlighting for parameters
            Token.Unreachable: 'dim italic #555555',  # Dead code - very dimmed
...
clara_style={Token: '',
            Token.Callable: 'bold #003cf0',  # Jedi semantic highlighting for callables
            Token.Module: 'bold #3126ff',  # Jedi semantic highlighting for modules
            Token.Parameter: 'bold #3126ff',  # Jedi semantic highlighting for parameters
            Token.Parameter.Unused: 'dim',  # Jedi semantic highlighting for parameters
            Token.Unreachable: 'dim italic #555555',  # Dead code - very dimmed
...
new_clara_style_diff={
            ...
            Token.Module: 'bold #ffff00',  # Jedi semantic highlighting for modules
            Token.Parameter: 'bold #ffff00',  # Jedi semantic highlighting for parameters
            Token.Parameter.Unused: 'dim',  # Jedi semantic highlighting for parameters
            Token.Unreachable: 'dim italic #555555',  # Dead code - very dimmed
...
random_syntax_style={Token: random_style(),
            Token.Callable: random_style(),  # Jedi semantic highlighting for callables
            Token.Module: random_style(),  # Jedi semantic highlighting for modules
            Token.Parameter: random_style(),  # Jedi semantic highlighting for parameters
            Token.Unreachable: 'dim italic #555555',  # Dead code - very dimmed
...
viper_style={Token: '',
            Token.Callable:                          ' bold        #bb0091',  # Jedi semantic highlighting for callables
            Token.Module:                            ' bold        #ff3126',  # Jedi semantic highlighting for modules
            Token.Parameter:                            ' bold        #ff3126',  # Jedi semantic highlighting for parameters
            Token.Parameter.Unused:                            'dim',  # Jedi semantic highlighting for parameters
            Token.Unreachable: 'dim italic #555555',  # Dead code - very dimmed
...
stratus_style={Token: '',
            Token.Callable:                          ' bold        #91bb00',  # Jedi semantic highlighting for callables
            Token.Module:                            ' bold        #26ff31',  # Jedi semantic highlighting for modules
            Token.Parameter:                            ' bold        #26ff31',  # Jedi semantic highlighting for parameters
            Token.Parameter.Unused:                            'dim',  # Jedi semantic highlighting for parameters
            Token.Unreachable: 'dim italic #555555',  # Dead code - very dimmed
...
snape_style={Token.Callable: 'bold #0091bb',  # Jedi semantic highlighting for callables
            Token.Module: 'bold #3126ff',  # Jedi semantic highlighting for modules
            Token.Parameter: 'bold #3126ff',  # Jedi semantic highlighting for parameters
            Token.Parameter.Unused: 'dim',  # Jedi semantic highlighting for parameters
            Token.Unreachable: 'dim italic #555555',  # Dead code - very dimmed
...
stars_2.update({
    Token.Callable:                               'bold #4c95bf',  # Jedi semantic highlighting for callables
    Token.Module:                                 'bold #ffff44',  # Jedi semantic highlighting for modules
    Token.Parameter:                                 'bold #ffff44',  # Jedi semantic highlighting for parameters
    Token.Parameter.Unused:                                 'dim',  # Jedi semantic highlighting for parameters
    Token.Unreachable: 'dim italic #555555',  # Dead code - very dimmed
...
temp = {
    Token.Callable: 'bold #00fa00',  # Jedi semantic highlighting for callables
    Token.Module: 'bold #fefe50',  # Jedi semantic highlighting for modules
    Token.Parameter: 'bold #fefe50',  # Jedi semantic highlighting for parameters
    Token.Parameter.Unused: 'dim',  # Jedi semantic highlighting for parameters
    Token.Unreachable: 'dim italic #555555',  # Dead code - very dimmed
...
temp.update({
    ...
    Token.Callable:                                       'bold #0088ff',  # Jedi semantic highlighting for callables
    Token.Module:                                         'bold #ffcc00',  # Jedi semantic highlighting for modules
    Token.Parameter:                                         'bold #ffcc00',  # Jedi semantic highlighting for parameters
    Token.Parameter.Unused:                                         'dim',  # Jedi semantic highlighting for parameters
    Token.Unreachable: 'dim italic #555555',  # Dead code - very dimmed
})
plain=temp
...
temp = {
    Token.Callable:                                       'bold #fafafa',  # Jedi semantic highlighting for callables
    Token.Module:                                         'bold #e3e3e3',  # Jedi semantic highlighting for modules
    Token.Parameter:                                         'bold #e3e3e3',  # Jedi semantic highlighting for parameters
    Token.Parameter.Unused:                                         'dim',  # Jedi semantic highlighting for parameters
    Token.Unreachable: 'dim italic #555555',  # Dead code - very dimmed
...
jenny=plain.copy()
jenny.update({
    Token.Callable:                                       'bold #00ff00       noinherit',  # Jedi semantic highlighting for callables
    Token.Module:                                         'bold #ffff00       noinherit',  # Jedi semantic highlighting for modules
    Token.Parameter:                                         'bold #ffff00       noinherit',  # Jedi semantic highlighting for parameters
    Token.Parameter.Unused:                                         'dim',  # Jedi semantic highlighting for parameters
    Token.Unreachable: 'dim italic #555555',  # Dead code - very dimmed
...
tomorrow_night_blue_style = {Token.Callable: 'bold #bbdaff',  # Jedi semantic highlighting for callables
Token.Module: 'bold #ffeead',  # Jedi semantic highlighting for modules
Token.Parameter: 'bold #ffeead',  # Jedi semantic highlighting for parameters
Token.Parameter.Unused: 'dim',  # Jedi semantic highlighting for parameters
...
tomorrow_night_bright_style = {Token.Callable: 'bold #7aa6da',  # Jedi semantic highlighting for callables
Token.Module: 'bold #e78c45',  # Jedi semantic highlighting for modules
Token.Parameter: 'bold #e78c45',  # Jedi semantic highlighting for parameters
Token.Parameter.Unused: 'dim',  # Jedi semantic highlighting for parameters
...
for sty in [tomorrow_night_eighties,synthwave_monokai,clara_monokai,sunset_monokai,synthwave_monokai_style,monokai_style,monokai]:
    #Parenthesis coloring and semantic highlighting
            sty[Token.Punctuation]='             #fb51a6'
            sty[Token.Unreachable]='dim italic #555555'
            sty[Token.KwargName]='#ffb86c'  # Orange-yellow for keyword arguments
            # sty[Token.Callable]='bold #66d9ef'  # Callables
            sty[Token.Callable]='#81E053'  # Callables - greenish
            # sty[Token.Callable]='#77f057'  # Callables - greenish
            sty[Token.Module]='#fdfd1f'  # Modules
            sty[Token.Parameter]='#fd971f'  # Parameters
            sty[Token.Parameter.Unused]='dim'  # Unused parameters
            sty[Token.Global]='#c0d8ff'  # Global variables - near-white blue
            sty[Token.Local]='#c8ffc8'  # Local variables - near-white green
            sty[Token.Nonlocal]='#c0ffe8'  # Nonlocal variables - near-white green-teal
